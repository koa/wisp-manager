...
/interface ethernet
	set [ find mac-address=B2:8E:06:FA:70:90 ] master-port=none speed=1Gbps name=customer
	set [ find mac-address=B2:8E:06:FA:70:91 ] master-port=none speed=1Gbps name=station-connection-1
	set [ find mac-address=B2:8E:06:FA:70:92 ] master-port=none speed=1Gbps name=station-connection-2
	set [ find mac-address=B2:8E:06:FA:70:93 ] master-port=none speed=1Gbps name=station-connection-3
	set [ find mac-address=B2:8E:06:FA:70:94 ] master-port=none speed=1Gbps name=station-connection-4
/interface vlan
	remove numbers=[find]

/interface ipipv6
#	remove numbers=[find]
	add local-address=fd7e:907d:34ab:0:0:0:0:3 mtu=1500 name=tunnel-Berg remote-address=fd7e:907d:34ab:0:0:0:0:0
...
# configured IPs
	add address=172.17.5.1/24 interface=customer
...
/routing ospf network
	...
	add area=backbone network=172.17.5.0/24
...
/ip pool
	remove numbers=[find]
	add name=customer_pool ranges=172.17.5.20-172.17.5.100
...
/ip firewall filter
	...
	add action=reject chain=forward in-interface=customer reject-with=icmp-admin-prohibited src-address=!172.17.5.0/24
	add action=reject chain=input in-interface=customer reject-with=icmp-admin-prohibited src-address=!172.17.5.0/24
/ip firewall nat
	remove numbers=[find]
...
# Connection IPs
	add address=2001:1620:bba:5:0:0:0:0/64 interface=customer
...
/ipv6 firewall filter
	...
	add action=reject chain=forward in-interface=customer reject-with=icmp-admin-prohibited src-address=!2001:1620:bba:5:0:0:0:0/64
	add action=reject chain=input in-interface=customer reject-with=icmp-admin-prohibited src-address=!2001:1620:bba:5:0:0:0:0/64
