...
/interface ethernet
	set [ find mac-address=B2:8E:03:FA:70:90 ] master-port=none speed=1Gbps name=customer-1
...
/interface ipipv6
#	remove numbers=[find]
	add local-address=fd7e:907d:34ab:0:0:0:0:1 mtu=1450 name=tunnel-berg remote-address=fd7e:907d:34ab:0:0:0:0:0
...
# ipv4 ospf Routing
/routing ospf instance set [ find default=yes ] distribute-default=if-installed-as-type-1 router-id=172.16.0.2
...
/routing ospf-v3 instance set [ find default=yes ] distribute-default=if-installed-as-type-1 router-id=172.16.0.2
