...
/interface ethernet
	set [ find mac-address=B2:8E:03:FA:70:90 ] master-port=none speed=1Gbps name=cyberlink
	set [ find mac-address=B2:8E:03:FA:70:91 ] master-port=none speed=1Gbps name=customer-1
